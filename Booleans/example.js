...
const tweede_check = !((laagTemp < 10) || (gemTemp < 25)); // == !(laagTemp < 10) && !(gemTemp <25) == (laagTemp >= 10) && (gemTemp >= 25)
const isWarmLand = eerste_check || tweede_check;
const long_check = (gemTemp >= 20) && (neerslag < 750) || !((laagTemp < 10) || (gemTemp < 25));
